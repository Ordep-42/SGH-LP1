...
public:
    MedicalFile(vector<string> newCurrentMedications, string newBloodType, vector<string> newAllergies, vector<string> newVaccinationRegistry, vector<string> newNotes, string newSex);  
