...
short* daysToDateBF(short days, short year) {
    ...
    /*const*/ short daysInMonths[] = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
    if (isLeapYear) 
        daysInMonths[1] = 29;
...
short Date::getDay() const {    
    ...
    delete[] date; // Comente esta linha se daysToDateBF NÃO aloca memória dinamicamente
